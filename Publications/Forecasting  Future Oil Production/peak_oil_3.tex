...
\author{L. Fiévet, Z. Forró, %M. del Degan, 
...
dynamics. This ability reflects directly that the total
production is indeed the sum of the contributions of the individual
oil fields in production. Thus modelling at the level of each field
...
This effect would cap the carrying capacity at a value smaller than 
the one shown in figure  \ref{rate_of_discovery}. To address these issues, the method
...
that the most probable scenario is that no other giant field will be found.}
\centering %
\begin{tabular}{lllll}
...
\begin{enumerate}
\item Draw a scenario based on its probability. {\bf DIDIER: Lucas, Peter expresses
that he does not understand how this is done. Please give more detail on 
how a scenario is chosen according to its probability and how the probability
is determined. A quick synthesis here would be useful.}
...
new fields. {\bf DIDIER: what is the meaning of ``shifted''? Peter does not fully
understand what is done here, neither do I..}
