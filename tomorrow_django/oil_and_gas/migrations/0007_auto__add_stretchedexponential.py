...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StretchedExponential'
        db.create_table(u'oil_and_gas_stretchedexponential', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_begin', self.gf('django.db.models.fields.DateField')()),
            ('date_end', self.gf('django.db.models.fields.DateField')()),
            ('x_min', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ...
            ('tau', self.gf('django.db.models.fields.FloatField')(default=-1.0)),
            ('beta', self.gf('django.db.models.fields.FloatField')(default=1.0)),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fits', to=orm['oil_and_gas.Field'])),
            ('r_squared', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('sum_error', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'oil_and_gas', ['StretchedExponential'])


    def backwards(self, orm):
        # Deleting model 'StretchedExponential'
        db.delete_table(u'oil_and_gas_stretchedexponential')
    ...
    models = {
        ...
        u'oil_and_gas.stretchedexponential': {
            'A': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'Meta': {'object_name': 'StretchedExponential'},
            'beta': ('django.db.models.fields.FloatField', [], {'default': '1.0'}),
