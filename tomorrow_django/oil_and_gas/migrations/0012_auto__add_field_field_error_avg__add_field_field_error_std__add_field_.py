...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Field.error_avg'
        db.add_column(u'oil_and_gas_field', 'error_avg',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)

        # Adding field 'Field.error_std'
        db.add_column(u'oil_and_gas_field', 'error_std',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)

        # Adding field 'Country.error_avg'
        db.add_column(u'oil_and_gas_country', 'error_avg',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)

        # Adding field 'Country.error_std'
        db.add_column(u'oil_and_gas_country', 'error_std',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Field.error_avg'
        db.delete_column(u'oil_and_gas_field', 'error_avg')

        # Deleting field 'Field.error_std'
        db.delete_column(u'oil_and_gas_field', 'error_std')

        # Deleting field 'Country.error_avg'
        db.delete_column(u'oil_and_gas_country', 'error_avg')

        # Deleting field 'Country.error_std'
        db.delete_column(u'oil_and_gas_country', 'error_std')
