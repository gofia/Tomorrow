...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Field.date_begin'
        db.add_column(u'oil_and_gas_field', 'date_begin',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 17, 0, 0)),
                      keep_default=False)

        # Adding field 'Country.date_begin'
        db.add_column(u'oil_and_gas_country', 'date_begin',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 17, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Field.date_begin'
        db.delete_column(u'oil_and_gas_field', 'date_begin')

        # Deleting field 'Country.date_begin'
        db.delete_column(u'oil_and_gas_country', 'date_begin')
