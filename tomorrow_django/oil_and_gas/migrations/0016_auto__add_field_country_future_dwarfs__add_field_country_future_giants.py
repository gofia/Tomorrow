...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.future_dwarfs'
        db.add_column(u'oil_and_gas_country', 'future_dwarfs',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Country.future_giants'
        db.add_column(u'oil_and_gas_country', 'future_giants',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.future_dwarfs'
        db.delete_column(u'oil_and_gas_country', 'future_dwarfs')

        # Deleting field 'Country.future_giants'
        db.delete_column(u'oil_and_gas_country', 'future_giants')
    ...
    models = {
        u'oil_and_gas.country': {
            ...
            'date_begin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
        ...
        u'oil_and_gas.stretchedexponential': {
            ...
            'date_begin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
            'date_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)'}),
