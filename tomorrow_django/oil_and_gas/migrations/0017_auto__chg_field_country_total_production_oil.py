...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Country.total_production_oil'
        db.alter_column(u'oil_and_gas_country', 'total_production_oil', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Country.total_production_oil'
        db.alter_column(u'oil_and_gas_country', 'total_production_oil', self.gf('django.db.models.fields.PositiveIntegerField')())
