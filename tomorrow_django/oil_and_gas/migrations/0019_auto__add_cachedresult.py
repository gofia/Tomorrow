...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CachedResult'
        db.create_table(u'oil_and_gas_cachedresult', (
        ...
        db.send_create_signal(u'oil_and_gas', ['CachedResult'])


    def backwards(self, orm):
        # Deleting model 'CachedResult'
        db.delete_table(u'oil_and_gas_cachedresult')


    models = {
        u'oil_and_gas.cachedresult': {
            'Meta': {'object_name': 'CachedResult'},
        ...
        u'oil_and_gas.country': {
            ...
            'date_begin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
        ...
        u'oil_and_gas.stretchedexponential': {
            ...
            'date_begin': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
            'date_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 22, 0, 0)'}),
